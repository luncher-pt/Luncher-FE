...
export const fetchingSchoolsAction = () => dispatch => {
    ...
    return axios
                ...
                .then( resp => dispatch({type: FETCHING_SCHOOLS_SUCCESS, payload: resp.data}) )
                .catch( err => dispatch({type: FETCHING_SCHOOLS_FAILURE, error: err.message}) );
};
...
export const addingSchoolAction = (newSchool) => dispatch => {
    ...
    return axios
                ...
                .catch( err => dispatch({type: ADDING_SCHOOL_FAILURE, error: err.message}) );
};
...
export const deletingSchoolAction = (id) => dispatch => {
    ...
    return axios
                ...
                .catch( err => dispatch({type: DELETING_SCHOOL_FAILURE, error: err.message}) );
};
...
export const updatingSchoolAction = (updatedSchool) => dispatch => {
    ...
    return axios
                ...
                .then( resp => dispatch({type: UPDATING_SCHOOL_SUCCESS, payload: resp.data}) )
                .catch( err => dispatch({type: UPDATING_SCHOOL_FAILURE, error: err.message}) );
};
