...
import { FETCHING_SCHOOLS, FETCHING_SCHOOLS_SUCCESS, FETCHING_SCHOOLS_FAILURE } from "../actions";
import { ADDING_SCHOOL, ADDING_SCHOOL_SUCCESS, ADDING_SCHOOL_FAILURE } from "../actions";
import { DELETING_SCHOOL, DELETING_SCHOOL_SUCCESS, DELETING_SCHOOL_FAILURE } from "../actions";
import { UPDATING_SCHOOL, UPDATING_SCHOOL_SUCCESS, UPDATING_SCHOOL_FAILURE } from "../actions";
...
const reducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case DELETING_SCHOOL_SUCCESS:
      state = {...state, deletingSchool: false, schools: action.payload};
      break;
